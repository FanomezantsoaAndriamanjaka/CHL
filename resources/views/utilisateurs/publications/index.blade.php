...
@section('content')
    ...
    <section class="scroll-mt-28 mt-2 mb-2 bg-blue-500 mx-2 rounded-xl border border-blue-50 shadow-lg p-8">   
    ...
    <div class="text-center p-8 mb-10">
        <div
    ...
    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 p-2 xl:grid-cols-3 gap-6">
